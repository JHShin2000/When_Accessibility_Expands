...
use "input\lastcollapse.dta"
local control col marriage manufacture population

*synthetic control
foreach y of varlist emp_all emp_col emp_hig workhour_all workhour_col workhour_hig  lnrealwage_all lnrealwage_col lnrealwage_hig lnrealwageperhour_all lnrealwageperhour_col lnrealwageperhour_hig {
...
esttab emp_all workhour_all lnrealwage_all lnrealwageperhour_all  ///
...
esttab emp_hig workhour_hig lnrealwage_hig lnrealwageperhour_hig  ///
	using "output/table5.tex", /// 
...
esttab emp_col workhour_col lnrealwage_col lnrealwageperhour_col  ///
	using "output/table5.tex", /// 
	append bookt fragment ///
    label keep(did)  ///
    cells(b(fmt(3) star) se(par fmt(3))) ///
